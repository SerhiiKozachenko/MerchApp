...
var _logger, _elogger, _alogger;

function initCommonLogger() {
  if(typeof _logger === 'undefined') {
    console.log('Common logger created.');
    ...
    _logger = {
      transports: [
        ...
        new (winston.transports.File)({
            filename: 'src/logs/common.log',
            timestamp: true,
            maxsize: 1048576 // 1Mb
        }),
        new (winston.transports.MongoDB)({
            db: 'merchdb',
            collection: 'commonlogs',
            host: 'localhost',
            port: '27017'
        })
      ]
    ...
    _container.add('commonLogger',_logger);
    _logger = _container.get('commonLogger');
  }
};

function initErrorLogger() {
  if(typeof _elogger === 'undefined') {
    console.log('Error logger created.');
